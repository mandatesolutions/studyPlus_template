...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var typed = new Typed(".typed", {
    strings: ["Conduct Online Exam","Conduct Mock Practice","Provide Study Materials"],
    typeSpeed: 150,
    backSpeed: 100,
    backDelay: 2000,
    loop: true,
...
document.getElementById('exam').addEventListener('click', function() {
  var examRegistrationModal = new bootstrap.Modal(document.getElementById('exampleModal'));
  examRegistrationModal.show();
});